...
def evaluate_model(model, gt_dir, input_dir, output_dir, device="cuda"):
    ...
    with torch.no_grad():
        ...
        for index in tqdm(range(len(test_files)), desc="Processing files"):  
            ...
            gt_points = load_kitti_bin(gt_files[index])[:, :3]
...
def main():
    ...
    input_dir = "/home/server01/js_ws/dataset/vertical_downsampled/test/*.bin"
    gt_dir = "/home/server01/js_ws/dataset/vertical_downsampled/test_GT/*.bin"
    output_dir = "/home/server01/js_ws/lidar_test/evaluate_output/vertical_finals"
