...
void pushlish_error_text(const double e_t,
                         const double e_r,
...
public:
    ...
    /**
     * @brief build semantic std descriptor for the map instance pc
     *
     * @param instance_pc
     * @param stds_vec
     */
    ...
    /**
     * @brief build semantic covariance std descriptor for the map instance pc
     *
     * @param instance_pc
     * @param cluster_cov_vec
     * @param stds_vec
     */
    void BuildMapCovSTD(
            const pcl::PointCloud<pcl::PointXYZLNormal>::Ptr &instance_pc,
    ...
    /**
     * @brief build semantic covariance std descriptor for one single semantic
     * instance scan
     *
     * @param instance_pc
     * @param cluster_cov_vec
    ...
    /**
     * @brief search similar Sem STDs from the map, return the
     * correspondences
     *
     * @param map_stds_vec
     * @param curr_stds_vec
     */
    void SearchCorresSemSTD(const std::vector<STDesc> &curr_stds_vec,
                            const std::vector<STDesc> &map_stds_vec);

    /**
     * @brief search similar Geo STDs from the map, return the
     * correspondences
     *
     * @param map_stds_vec
     * @param curr_stds_vec
     */
    void SearchCorresGeoSTD(const std::vector<STDesc> &curr_stds_vec,
                            const std::vector<STDesc> &map_stds_vec);
...
private:
    ...
    /**
     * @brief select similar semantic STDs in the map_stds_vec
     *
     * @param curr_stds_vec stds constructed by current semantic clusters
     * @param map_stds_vec stds in the reference map
     */
    void semantic_selector(const std::vector<STDesc> &curr_stds_vec,
                           const std::vector<STDesc> &map_stds_vec);

    /**
     * @brief select similar geo STDs in the map_stds_vec
     *
     * @param curr_stds_vec stds constructed by current geometric clusters
     * @param map_stds_vec stds in the reference map
     */
    void naive_selector(const std::vector<STDesc> &curr_stds_vec,
                        const std::vector<STDesc> &map_stds_vec);
