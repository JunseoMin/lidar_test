...
#include <filesystem>   // <-- For create_directories (C++17)
#include <Eigen/Dense>
                      ...
                      const std::string &filename)
{
    ...
    fs::path parent_dir = outpath.parent_path();
    if(!parent_dir.empty()){
        std::error_code ec;
        fs::create_directories(parent_dir, ec);
        if(ec){
            std::cerr << "[Error] Failed to create directory: " 
                      << parent_dir << " - " << ec.message() << std::endl;
            return;
        }
    }

    // 2) Write the file in binary mode
                       ...
                       const std::string &filename)
{
    ...
    for(size_t i = 0; i < covariances.size(); i++){
        ...
        // If you want to write the covariance matrix:
        // ofs << "Cov:\n" << covariances[i] << "\n";

        // If you want to write subcloud indices:
...
#pragma omp for schedule(dynamic)
        for(size_t i=0; i<uniqueLabels.size(); i++)
        {
            ...
            // Build a subcloud for the current label
            ...
            for(const auto &inds : cluster_indices)
            {
                ...
                // We'll map subcloud indices -> original indices
                ...
                local_subcloud_indices.push_back(inds);
                local_original_indices.push_back(cluster_orig_indices);

                local_labels.push_back(labelVal);
                local_clusterIDs.push_back(localID++);
            }
        } // end for unique labels
...
int main(int argc, char* argv[]) 
{
    ...
    try {
        processPointCloud("/home/server01/js_ws/dataset/encoder_dataset_TEASER/semantic_map/00_map.bin","/home/server01/js_ws/dataset/encoder_dataset_TEASER/inlier_map/00/centroids.bin","/home/server01/js_ws/dataset/encoder_dataset_TEASER/inlier_map/00/cov.txt");
        processPointCloud("/home/server01/js_ws/dataset/encoder_dataset_TEASER/semantic_map/01_map.bin","/home/server01/js_ws/dataset/encoder_dataset_TEASER/inlier_map/01/centroids.bin","/home/server01/js_ws/dataset/encoder_dataset_TEASER/inlier_map/01/cov.txt");
        processPointCloud("/home/server01/js_ws/dataset/encoder_dataset_TEASER/semantic_map/02_map.bin","/home/server01/js_ws/dataset/encoder_dataset_TEASER/inlier_map/02/centroids.bin","/home/server01/js_ws/dataset/encoder_dataset_TEASER/inlier_map/02/cov.txt");
        processPointCloud("/home/server01/js_ws/dataset/encoder_dataset_TEASER/semantic_map/03_map.bin","/home/server01/js_ws/dataset/encoder_dataset_TEASER/inlier_map/03/centroids.bin","/home/server01/js_ws/dataset/encoder_dataset_TEASER/inlier_map/03/cov.txt");
        processPointCloud("/home/server01/js_ws/dataset/encoder_dataset_TEASER/semantic_map/04_map.bin","/home/server01/js_ws/dataset/encoder_dataset_TEASER/inlier_map/04/centroids.bin","/home/server01/js_ws/dataset/encoder_dataset_TEASER/inlier_map/04/cov.txt");
        processPointCloud("/home/server01/js_ws/dataset/encoder_dataset_TEASER/semantic_map/05_map.bin","/home/server01/js_ws/dataset/encoder_dataset_TEASER/inlier_map/05/centroids.bin","/home/server01/js_ws/dataset/encoder_dataset_TEASER/inlier_map/05/cov.txt");
        processPointCloud("/home/server01/js_ws/dataset/encoder_dataset_TEASER/semantic_map/06_map.bin","/home/server01/js_ws/dataset/encoder_dataset_TEASER/inlier_map/06/centroids.bin","/home/server01/js_ws/dataset/encoder_dataset_TEASER/inlier_map/06/cov.txt");
        processPointCloud("/home/server01/js_ws/dataset/encoder_dataset_TEASER/semantic_map/07_map.bin","/home/server01/js_ws/dataset/encoder_dataset_TEASER/inlier_map/07/centroids.bin","/home/server01/js_ws/dataset/encoder_dataset_TEASER/inlier_map/07/cov.txt");
        processPointCloud("/home/server01/js_ws/dataset/encoder_dataset_TEASER/semantic_map/08_map.bin","/home/server01/js_ws/dataset/encoder_dataset_TEASER/inlier_map/08/centroids.bin","/home/server01/js_ws/dataset/encoder_dataset_TEASER/inlier_map/08/cov.txt");
        processPointCloud("/home/server01/js_ws/dataset/encoder_dataset_TEASER/semantic_map/09_map.bin","/home/server01/js_ws/dataset/encoder_dataset_TEASER/inlier_map/09/centroids.bin","/home/server01/js_ws/dataset/encoder_dataset_TEASER/inlier_map/09/cov.txt");
        processPointCloud("/home/server01/js_ws/dataset/encoder_dataset_TEASER/semantic_map/10_map.bin","/home/server01/js_ws/dataset/encoder_dataset_TEASER/inlier_map/10/centroids.bin","/home/server01/js_ws/dataset/encoder_dataset_TEASER/inlier_map/10/cov.txt");
        processPointCloud("/home/server01/js_ws/dataset/encoder_dataset_TEASER/semantic_map/11_map.bin","/home/server01/js_ws/dataset/encoder_dataset_TEASER/inlier_map/11/centroids.bin","/home/server01/js_ws/dataset/encoder_dataset_TEASER/inlier_map/11/cov.txt");
    } 
