...
def train_model(rank, world_size, train_file_paths, gt_file_paths):
    ...
    train_loader = DataLoader(train_dataset, sampler=train_sampler, batch_size=1, num_workers=16)
    gt_loader = DataLoader(gt_dataset, sampler=gt_sampler, batch_size=1, num_workers=16)
...
if __name__ == "__main__":
    ...
    torch.multiprocessing.spawn(
        train_model,
        args=(world_size, train_file_paths, gt_file_paths),
        nprocs=world_size,
        join=True
    )
